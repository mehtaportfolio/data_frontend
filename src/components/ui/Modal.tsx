...
export function Modal({
  ...
  return <AnimatePresence>
      {isOpen && <>
        ...
        damping: 25,
        stiffness: 300
      }} className="fixed inset-x-0 top-0 z-50 bg-white dark:bg-gray-900 rounded-b-3xl shadow-xl max-h-[90vh] flex flex-col md:inset-0 md:max-w-lg md:m-auto md:h-fit md:rounded-2xl">
